...
The Alloy4Fun is a web platform to support the teaching of the Alloy formal method, allowing:
- the sharing of Alloy models, specifications and instances with embedded themes via permalinks
- the creation of specification challenges in which students try to guess a secret specification
- the collection of models and specifications to build a valuable corpus of data to support research

Alloy4Fun is built on top of [Alloy 6](https://alloytools.org/) and is currently deployed at [alloy4fun.inesctec.pt](http://alloy4fun.inesctec.pt/).

## Tutorials on teaching with Alloy4Fun

- A [tutorial](https://haslab.github.io/Alloy4Fun/tutorial.html) at the 9th International Conference on Rigorous State-Based Methods, [ABZ'23](https://abz2023.loria.fr/) ([slides](https://nmacedo.github.io/talks/ABZ23.pdf))
- A [tutorial](https://fme-teaching.github.io/2021/08/24/tutorial-series-of-the-fme-teaching-committee/#spoiler-16) at the [Tutorial Series](https://fme-teaching.github.io/2021/08/24/tutorial-series-of-the-fme-teaching-committee/) of the FME Teaching Committee ([recording](https://panopto.abo.fi/Panopto/Pages/Viewer.aspx?id=64389960-29d9-4430-82c2-b106007baad8))
...
- Alloy4Fun [dataset](https://zenodo.org/records/17390557) with student submissions (most recent version with data from 2019 to 2025)
- Alloy4Fun [dataset](https://zenodo.org/records/17392203) processed for semantically and syntatically similar submissions 

## Projects

- Alloy4Fun was initially developed in the context of the [TRUST](https://haslab.github.io/TRUST/) project (POCI-01-0145-FEDER-016826)
- Further developements were made in the context of the [SpecRep](https://haslab.github.io/SpecRep/) project (EXPL/CCI-COM/1637/2021)
